    ...
    .then((data) => {
      ...
      data.forEach((element) => {
        if (
          ...
          if (decodedPayload.categoria === "projeto") {
            resPayloads.push(decodedPayload);
          }
        }
      });
    ...
    .then((data) => {
      ...
      data.forEach((element) => {
        if (
          ...
          if (decodedPayload.categoria === "requisito") {
            resPayloads.push(decodedPayload);
          }
        }
      });
    ...
    .then((data) => {
      ...
      data.forEach((element) => {
        if (
          ...
          if (decodedPayload.categoria === "utilizador") {
            resPayloads.push(decodedPayload);
          }
        }
      });
    ...
    .then((data) => {
      ...
      data.forEach((element) => {
        if (
          ...
          if (decodedPayload.tipo === "Developer") {
            resPayloads.push(decodedPayload);
          }
        }
      });
    ...
    .then((data) => {
      ...
      data.forEach((element) => {
        if (
          ...
          if (decodedPayload.tipo === "Gestor de Equipa") {
            resPayloads.push(decodedPayload);
          }
        }
      });
